...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--yaml', type=str, default='dataset/dataset.yaml', help='data yaml file.')
    ...
    parser.add_argument('--name', default='pengujian', help='save inference results to project/name.')
